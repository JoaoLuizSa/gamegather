...
class FormController extends Controller
{
    ...
    public function index()
    {
       ...
       // $titulo ='Formularios Recebidos';
        //$subtitulo ='Tabela de Formularios recebidos';
        $formu = $this->form->all();
    ...
    {   
        ...
        $data= $data['busca'];
     // dd($data);
       $local = $this->form->where('name',$data)->get();
    //   dd($local);
        

        return view('painel.formularios.show',compact('local'));
    }
